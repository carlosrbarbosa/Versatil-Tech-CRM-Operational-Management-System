document.addEventListener('DOMContentLoaded', () => {
  ...
  const SEED_BASE = [
    ...
    { codigo: 3067, nome: 'AUTO POSTO ECO GAS LTDA', cnpj: '57.900.011/0001-45', rede: 'Rede Esperança', status: 'Ativo',
      acessos: [
        {estacao:'PDV PISTA', tipo:'AnyDesk', id:'628629801', usuario:'', senha:'teste1'},
        {estacao:'RET - GERENTE', tipo:'AnyDesk', id:'907072440', usuario:'', senha:'teste1'}
      ]},
    { codigo: 3175, nome: 'MASTER VALE AUTO POSTO LTDA', cnpj: '11.233.578/0001-04', rede: 'Rede Master', status: 'Inativo',
      acessos: [
        {estacao:'RET - GERENTE', tipo:'AnyDesk', id:'502451554', usuario:'', senha:'teste1'},
        {estacao:'PDV PISTA NOVO', tipo:'AnyDesk', id:'211731358', usuario:'', senha:'teste1'}
      ]},
    { codigo: 3037, nome: 'AUTO POSTO GUAIAMASTER LTDA', cnpj: '15.042.777/0001-96', rede: 'Rede Master', status: 'Ativo',
      acessos: [
        {estacao:'RETAGUARDA', tipo:'AnyDesk', id:'452567802', usuario:'', senha:'teste1'},
        {estacao:'PDV PISTA', tipo:'AnyDesk', id:'1953156198', usuario:'', senha:'teste1'}
      ]},
    { codigo: 3035, nome: 'LEAO CENTER AUTO POSTO LEDA', cnpj: '18.019.333/0001-28', rede: 'Rede Master', status: 'Ativo',
      acessos: [
        {estacao:'RETAGUARDA', tipo:'AnyDesk', id:'795017616', usuario:'', senha:'teste1'},
        {estacao:'PISTA / SYNC / SERVIDOR PDV', tipo:'AnyDesk', id:'321894711', usuario:'', senha:'teste1'},
        {estacao:'LOJA - NOVO', tipo:'AnyDesk', id:'314476490', usuario:'', senha:'teste1'}
      ]},
    { codigo: 3036, nome: 'M SUPER COMBUSTIVEIS E LUBRIFICANTES LTDA', cnpj: '05.591.088/0001-87', rede: 'Rede Master', status: 'Ativo',
      acessos: [
        {estacao:'RETAGUARDA', tipo:'AnyDesk', id:'259895890', usuario:'', senha:'teste1'},
        {estacao:'RETAGUARDA 2', tipo:'AnyDesk', id:'610547388', usuario:'', senha:'teste1'},
        {estacao:'PDV / LOJA', tipo:'AnyDesk', id:'147275583', usuario:'', senha:'teste1'}
      ]},
    { codigo: 4234, nome: 'POSTO PARAENSE LTDA', cnpj: '19.863.197/0001-10', rede: 'Rede Martinelli', status: 'Inativo',
      acessos: [
        {estacao:'PISTA/BD/AUT/SYNC', tipo:'AnyDesk', id:'573679152', usuario:'', senha:'teste1'},
        {estacao:'RETAGUARDA', tipo:'AnyDesk', id:'978450498', usuario:'', senha:'teste1'}
      ]},
    { codigo: 4565, nome: 'ARGETAX PART. E EMPREEND. (ELISEU)', cnpj: '04.383.988/0004-19', rede: 'Rede Martinelli', status: 'Ativo',
      acessos: [
        {estacao:'PDV PISTA / SYNC', tipo:'AnyDesk', id:'266056029', usuario:'', senha:'teste1'},
        {estacao:'RETAGUARDA', tipo:'AnyDesk', id:'246018006', usuario:'', senha:'teste1'}
      ]},
    { codigo: 4564, nome: 'ARGETAX PART. (ROTARY-GUARULHOS)', cnpj: '04.383.988/0003-38', rede: 'Rede Martinelli', status: 'Ativo',
      acessos: [
        {estacao:'RETAGUARDA', tipo:'AnyDesk', id:'146066352', usuario:'', senha:'teste1'},
        {estacao:'PISTA/BD/SYNC/AUT', tipo:'AnyDesk', id:'1287529850', usuario:'', senha:'teste1'}
      ]},
    { codigo: 4762, nome: 'GASCEM AUTOMOTIVO LTDA', cnpj: '04.270.177/0001-69', rede: 'Rede Esperança', status: 'Ativo',
      acessos: [
        {estacao:'PISTA/AUT/BD/SYNC', tipo:'AnyDesk', id:'722085641', usuario:'', senha:'teste1'},
        {estacao:'LOJA', tipo:'AnyDesk', id:'307352270', usuario:'', senha:'teste1'},
        {estacao:'RETAGUARDA', tipo:'AnyDesk', id:'594766663', usuario:'', senha:'teste1'}
      ]},
    ...
    { codigo: 6137, nome: 'ECOPOSTO AVATARES LTDA', cnpj: '10.555.297/0001-05', rede: 'Rede Esperança', status: 'Ativo',
      acessos: [{estacao:'PISTA/AUT/BD/MOBILE/PAY', tipo:'AnyDesk', id:'1285540600', usuario:'', senha:'teste1'}] },
    { codigo: 6552, nome: 'TORINO AUTO POSTO LTDA', cnpj: '50.770.353/0001-49', rede: 'Rede Martinelli', status: 'Ativo',
      acessos: [{estacao:'PDV PISTA - SERVIDOR', tipo:'AnyDesk', id:'623726752', usuario:'', senha:'teste1'}] },
  ];
  ...
  function ensure40Clients(seed) {
    ...
    while (out.length < 40) {
      ...
      out.push({
        ...
        acessos: (idx % 4 === 0) ? [
          {estacao:'PDV PISTA', tipo:'AnyDesk', id:String(600000000 + idx), usuario:'', senha:'teste1'}
        ] : []
      });
    }
    return out;
